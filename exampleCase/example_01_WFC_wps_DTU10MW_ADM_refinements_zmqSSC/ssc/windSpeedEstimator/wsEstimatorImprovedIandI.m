classdef wsEstimatorImprovedIandI < matlab.mixin.Copyable %handle
    ...
    methods
        function obj = wsEstimatorImprovedIandI(turbineType,dt,gamma,beta,rotSpeedInitial,windSpeedInitial)
        ...
        function update(obj, genTorqueMeasured, rotSpeedMeasured, pitchMeasured)
            ...
            GBEfficiency = obj.turbineProperties.GBEfficiency; % Gearbox efficiency
